...
import com.rprescott.dndtool.server.ability.AbilityConfiguration;
import com.rprescott.dndtool.server.account.AccountConfiguration;
...
public class ContextConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sessionFactoryBean.setConfigLocation(
            new ClassPathResource("/com/rprescott/dndtool/server/mybatis-configuration.xml"));
